    ...
    >
      ...
      {selected && (
        <div className="rc-actions" onClick={(e) => e.stopPropagation()}>
          <a href={mapsUrl} target="_blank" rel="noopener noreferrer" className="rc-action-btn">
            <MapIcon size={14} />
            Directions
          </a>
          <a href={appleMapsUrl} target="_blank" rel="noopener noreferrer" className="rc-action-btn">
            <PinIcon size={14} />
            Open in Maps
          </a>
        </div>
